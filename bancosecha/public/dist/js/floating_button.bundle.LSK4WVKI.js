frappe.dom.set_style("/* sfc-style:/home/tzcode/frappe-bench/apps/bancosecha/bancosecha/public/js/floating_button/Main.vue?type=style&index=0 */\n.dropdown-menu {\n  display: none;\n  position: absolute;\n  background-color: var(--gray-400);\n  color: var(--text-color) !important;\n  min-width: 160px;\n  box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2);\n  z-index: 1;\n}\n.dropdown-menu.show {\n  display: block;\n}\n.dropdown-item {\n  padding: 12px 16px;\n  text-decoration: none;\n  display: block;\n}\n.dropdown-item:hover {\n  background-color: var(--gray-400);\n}\n.active {\n  background-color: var(--bg-color);\n}\n/*# sourceMappingURL=floating_button.bundle.OLN5AE6B.css.map */\n");
(() => {
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  // sfc-script:/home/tzcode/frappe-bench/apps/bancosecha/bancosecha/public/js/floating_button/Main.vue?type=script
  var Main_default = {
    __name: "Main",
    setup(__props, { expose: __expose }) {
      const treeData = ref(null);
      const actions = ref([]);
      const showButtonGroup = computed2(() => {
        var _a;
        return ((_a = actions.value) == null ? void 0 : _a.length) > 0 || treeData.value !== null;
      });
      function onClick(company, cost_center) {
        const method = "frappe.core.doctype.session_default_settings.session_default_settings.set_session_default_values";
        const args = {
          default_values: {
            company,
            cost_center
      ...
      function handleClick(action, evt) {
        if (action == null ? void 0 : action.handler) {
          action.handler(evt);
        }
      }
      function addAction(action) {
        var _a, _b;
        const display = (action == null ? void 0 : action.display) || {};
        const label = (_a = display == null ? void 0 : display.name) != null ? _a : action == null ? void 0 : action.label;
        const company = (_b = display == null ? void 0 : display.company) != null ? _b : action == null ? void 0 : action.company;
        if (!label) {
          frappe.throw("Name is required");
        }
        const normalized = __spreadProps(__spreadValues({}, action), { label, company, display });
      ...
      function getCssClass({ label }) {
        var _a, _b, _c;
        return {
          active: ((_c = (_b = (_a = frappe == null ? void 0 : frappe.boot) == null ? void 0 : _a.user) == null ? void 0 : _b.defaults) == null ? void 0 : _c.company) === label
        };
      }
      function obtainCssClass(cost_center) {
        var _a, _b, _c;
        return {
          active: ((_c = (_b = (_a = frappe == null ? void 0 : frappe.boot) == null ? void 0 : _a.user) == null ? void 0 : _b.defaults) == null ? void 0 : _c.cost_center) === cost_center
        };
      }
      ...
      onMounted(() => {
        var _a;
        if ((_a = frappe == null ? void 0 : frappe.router) == null ? void 0 : _a.on) {
          frappe.router.on("change", routeChangeHandler);
        }
      });
      onBeforeUnmount(() => {
        var _a;
        if ((_a = frappe == null ? void 0 : frappe.router) == null ? void 0 : _a.off) {
      ...
      const __returned__ = { treeData, actions, showButtonGroup, onClick, handleClick, addAction, removeActionByLabel, clearRouteSensitiveActions, getCssClass, obtainCssClass, setupTree, routeChangeHandler, ref, computed: computed2, onMounted, onBeforeUnmount };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/tzcode/frappe-bench/apps/bancosecha/bancosecha/public/js/floating_button/Main.vue?type=template
  var _hoisted_1 = {
    key: 0,
    class: "btn-group",
    role: "group",
  ...
  var _hoisted_3 = /* @__PURE__ */ createBaseVNode("button", {
    id: "floating_button",
    type: "button",
    ...
    "aria-haspopup": "true",
    "aria-expanded": "false",
    style: { "border-radius": "50%", "width": "50px", "height": "50px", "outline": "none", "box-shadow": "rgb(0 0 0 / 43%) 3px 3px 7px 0px" }
  }, [
    /* @__PURE__ */ createBaseVNode("span", {
      class: "menu-btn-group-label",
      "data-label": ""
    }, [
      /* @__PURE__ */ createBaseVNode("svg", { class: "icon icon-sm" }, [
        /* @__PURE__ */ createBaseVNode("use", { href: "#icon-change" })
      ])
    ])
  ], -1);
  var _hoisted_4 = {
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return $setup.showButtonGroup ? (openBlock(), createElementBlock("div", _hoisted_1, [
      createBaseVNode("div", _hoisted_2, [
        createCommentVNode(" Main button "),
        _hoisted_3,
        createCommentVNode(" Submenu "),
        $setup.treeData === null ? (openBlock(), createElementBlock("div", _hoisted_4, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($setup.actions, (d) => {
            return openBlock(), createElementBlock("li", {
              key: d.label
            }, [
              createBaseVNode("a", {
                class: normalizeClass(["dropdown-item", $setup.getCssClass(d)]),
                href: "#",
                onClick: withModifiers(($event) => $setup.handleClick(d, $event), ["prevent"])
              }, toDisplayString(d.label), 11, _hoisted_5)
            ]);
          }), 128))
        ])) : (openBlock(), createElementBlock("div", _hoisted_6, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys($setup.treeData), (company) => {
            return openBlock(), createElementBlock("li", { key: company }, [
              createBaseVNode("span", {
                ...
                createTextVNode(toDisplayString(company) + " ", 1),
                (openBlock(true), createElementBlock(Fragment, null, renderList($setup.treeData[company], (cc) => {
                  return openBlock(), createElementBlock("p", { key: cc }, [
                    createBaseVNode("a", {
                      class: normalizeClass(["dropdown-item", $setup.obtainCssClass(cc)]),
                      href: "#",
                      onClick: withModifiers(($event) => $setup.onClick(company, cc), ["prevent"]),
                      style: { "font-weight": "normal", "color": "black" }
                    }, " - " + toDisplayString(cc), 11, _hoisted_7)
                  ]);
                }), 128))
              ])
            ]);
  ...
  // ../bancosecha/bancosecha/public/js/floating_button/Main.vue
  Main_default.render = render;
  Main_default.__file = "../bancosecha/bancosecha/public/js/floating_button/Main.vue";
  var Main_default2 = Main_default;

  // ../bancosecha/bancosecha/public/js/floating_button/index.js
  ...
  var FloatingButton = class {
    ...
    make() {
      ...
      this.app = createApp(Main_default2);
  ...
  // ../bancosecha/bancosecha/public/js/floating_button.bundle.js
  frappe.provide("tzcode.floating_button");
  tzcode.floating_button = new floating_button_default([]);
  frappe.call(
...
/*! #__NO_SIDE_EFFECTS__ */
//# sourceMappingURL=floating_button.bundle.LSK4WVKI.js.map
